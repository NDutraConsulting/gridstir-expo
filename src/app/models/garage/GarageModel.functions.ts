...
function makeGetUrl() {
  // Server URLS
  const testGetUrl = 'http://localhost:4000/garage/';
 ...
 * @returns object
 */
export function _setCachedData(response: Vehicle[]) {
  return (GarageCache.data = response);
}
